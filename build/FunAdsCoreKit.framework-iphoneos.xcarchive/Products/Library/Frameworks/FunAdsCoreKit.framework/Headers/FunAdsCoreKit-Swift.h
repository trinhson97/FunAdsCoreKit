...
#ifndef FUNADSCOREKIT_SWIFT_H
#define FUNADSCOREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FunAdsCoreKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13FunAdsCoreKit13AdsIOSControl")
@interface AdsIOSControl : NSObject
+ (void)showAdsSDKWithCode:(NSString * _Nonnull)code id:(NSInteger)id;
...
SWIFT_CLASS("_TtC13FunAdsCoreKit8BaseView")
...
@interface BaseView (SWIFT_EXTENSION(FunAdsCoreKit))
- (void)layoutSubviews;
@end
...
SWIFT_CLASS("_TtC13FunAdsCoreKit10Conditions")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit18CornerRoundingView")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit6FunAds")
@interface FunAds : NSObject
- (void)init_adsWithApi_key:(NSString * _Nonnull)api_key appKey:(NSString * _Nullable)appKey SWIFT_METHOD_FAMILY(none);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit10FunAdsTest")
@interface FunAdsTest : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit20FunAdsWithConditions")
@interface FunAdsWithConditions : NSObject
- (void)saveUserInforWithToken:(NSString * _Nullable)token server_id:(NSString * _Nullable)server_id character_id:(NSString * _Nullable)character_id user_id:(NSString * _Nullable)user_id;
- (void)showAdsLevelUpWithValue:(NSInteger)value;
- (void)showAdsSaveCharacter;
- (void)showAdsPeriod;
- (void)showAdsExtractData;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit24FunAdsWithConditionsTest")
@interface FunAdsWithConditionsTest : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit9Inventory")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit20KeyboardTrackingView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC13FunAdsCoreKit12MarqueeLabel")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit11MessageView")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit10NinePayAds")
@interface NinePayAds : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit16PhysicsAnimation")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit7Storage")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit18SwiftMessagesSegue")
...
@interface SwiftMessagesSegue (SWIFT_EXTENSION(FunAdsCoreKit)) <UIViewControllerTransitioningDelegate>
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForPresentedController:(UIViewController * _Nonnull)presented presentingController:(UIViewController * _Nonnull)presenting sourceController:(UIViewController * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForDismissedController:(UIViewController * _Nonnull)dismissed SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC13FunAdsCoreKit18TopBottomAnimation")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit20WindowViewController")
...
SWIFT_CLASS("_TtC13FunAdsCoreKit13actionShowAds")
@interface actionShowAds : NSObject
+ (void)adsWithCode:(Inventory * _Nonnull)code;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
