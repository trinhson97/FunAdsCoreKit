...
class RewarAdsVertical: MessageView {
    ...
    @IBOutlet var replayVideoView: UIView! {
        didSet {
            print("labelView: \(String(describing: djdfhskdjfhskjdfhds))")
        }
    }
...
extension RewarAdsVertical: VideoViewDelegate {
